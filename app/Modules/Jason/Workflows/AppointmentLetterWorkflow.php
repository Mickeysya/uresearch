 ...
 * with comments) and the Dean of PGR gives final approval. On the Dean's
 * approval the controller generates the Appointment Letter PDF and emails it
 * straight to the examiner -- who has no account in this system at all, so
 * that dispatch happens outside the WorkflowEngine/ApplicationDecided path.
 * See AppointmentLetterController::issueLetter().
 *
