...
/**
 * Dismissal for exceeded candidacy — Dean → Faculty → Registry.
 *
 * norhanis.md Module 4, path 3: "Non-Exec CGS initiates dismissal. Routes to
 * Dean (Endorsement) → Faculty (Final Approval) → Registry (Sends termination
 * email)."
 *
    ...
    public function stages(?Application $application = null): array
    {
        return [
            ...
            new Stage(
                ...
                role: Role::REGISTRY,
                decision: 'approved',
                queueTitle: 'Terminations To Send',
            ),
        ];
    }
