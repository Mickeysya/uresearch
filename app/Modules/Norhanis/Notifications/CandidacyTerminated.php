...
class CandidacyTerminated extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->line('The decision was endorsed by the Dean of PGR, and approved by the Faculty. This notice is issued by the Registry. The full record is on your applications page.')
